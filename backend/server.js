...
const { installProductionConsoleSilence, logger } = require("./utils/logger");
...
const hallNotificationRoutes = require("./routes/hallNotificationRoutes");
const invigilationNotificationRoutes = require("./routes/invigilationNotificationRoutes");
...
app.use("/api/hall-notifications", hallNotificationRoutes);
app.use("/api/invigilation-notifications", invigilationNotificationRoutes);
